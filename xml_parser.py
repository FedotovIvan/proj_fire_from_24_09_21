...
if __name__ == '__main__':
    ...
    flow_meter_enable = [1,1,1,1,0]
    mb1_names = ["давл откл","давл овен4-20  ","давл возд в диф","давление вокруг","давл -2,3 0-10в","6","7","разница"]
    mb1_enable = [0,1,1,1,1,0,0,0]
    mb2_names = ["one","two","three","four","five","6","7","8"]
    mb2_enable = [0,0,0,0,0,0,0,0]
    flow_meter_id = [2,3,4,5,0]
    flow_meter_ch = [0,1,2,3,4]
    damp_id = [1,1,1,1,1]
    err = [0.007, 0.007, 0.007, 0.01, 0]
    damp_ch = [0,1,2,3,4]
